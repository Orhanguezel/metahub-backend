// src/modules/ensotekcategory/validation.ts
...
// 🟢 Create Ensotek Category (en az bir dilde name/description zorunlu)
export const validateCreateEnsotekCategory = [
  validateMultilangField("name"),
  validateMultilangField("description"),
  validateRequest,
];

// 🟢 Update Ensotek Category (alanlar opsiyonel, varsa tip ve içerik kontrolü)
export const validateUpdateEnsotekCategory = [
  body("name")
    .optional()
    .custom((value) => {
      let obj = value;
