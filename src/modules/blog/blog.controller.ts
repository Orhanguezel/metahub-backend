...
// ✅ Get All Blogs
export const getAllBlogs = asyncHandler(async (_req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
...
// ✅ Get Blog by Slug
export const getBlogBySlug = asyncHandler(async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
