// src/modules/gallerycategory/validation.ts
...
// 🟢 Create Gallery Category (en az bir dilde name/description zorunlu)
export const validateCreateGalleryCategory = [
  validateMultilangField("name"),
  validateMultilangField("description"),
  validateRequest,
];

// 🟢 Update Gallery Category (alanlar opsiyonel, varsa tip ve içerik kontrolü)
export const validateUpdateGalleryCategory = [
  body("name")
    .optional()
    .custom((value) => {
      let obj = value;
