...
// 🔸 Create custom pizza
export const createCustomPizza = asyncHandler(
...
export const getAllCustomPizzas = asyncHandler(
...
export const getCustomPizzaById = asyncHandler(
  async (req: Request, res: Response): Promise<void> => {
    const { id } = req.params;
...
// 🔸 Delete custom pizza
export const deleteCustomPizza = asyncHandler(
  async (req: Request, res: Response): Promise<void> => {
    const { id } = req.params;
