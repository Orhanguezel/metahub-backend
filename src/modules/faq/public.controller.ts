...
// ✅ GET /faqs?lang=en
export const getPublishedFAQs = asyncHandler(async (req: Request, res: Response): Promise<void> => {
...
export const askFAQ = asyncHandler(async (req: Request, res: Response): Promise<void> => {
  ...
  try {
    ...
    const aiAnswer = await askWithOllama({ question, context, lang: language });
