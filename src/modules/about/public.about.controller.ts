...
export const getAllAbout = asyncHandler(async (req: Request, res: Response): Promise<void> => {
...
export const getAboutById = asyncHandler(async (req: Request, res: Response): Promise<void> => {
  const { id } = req.params;
...
export const getAboutBySlug = asyncHandler(async (req: Request, res: Response): Promise<void> => {
